...
import static com.example.mozzie.mozlearning.b_utils.BubbleSeekBar.TextPosition.BELOW_SECTION_MARK;
import static com.example.mozzie.mozlearning.b_utils.BubbleSeekBar.TextPosition.BOTTOM_SIDES;
import static com.example.mozzie.mozlearning.b_utils.BubbleSeekBar.TextPosition.SIDES;
import static com.example.mozzie.mozlearning.b_utils.BubbleUtils.dp2px;
import static com.example.mozzie.mozlearning.b_utils.BubbleUtils.sp2px;

/**
 * Created by mozzie on 17/7/31.
 */
...
////                mSecondTrackSize + dp2px(2));
//        mThumbRadius = mThumbRadiusOnDragging = mSecondTrackSize;
//
...
//                ContextCompat.getColor(context, R.color.colorSeekbarBackground));
//        mSecondTrackColor = a.getColor(R.styleable.BubbleSeekBar_bsb_second_track_color,
//                ContextCompat.getColor(context, R.color.colorOrage));
...
//        }
    ...
    private void calculateRadiusOfBubble() {
        ...
        mBubbleRadius = dp2px(10); // default 14dp
